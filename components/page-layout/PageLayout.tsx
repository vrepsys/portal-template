...
export const PageLayout: React.FC<PropsWithChildren> = ({ children }) => {
  return (
    <>
      ...
      <TopNav />
      <div>
        <div className="mx-auto px-[var(--width-page-padding-mobile)] max-w-mobile flex justify-center lg:grid lg:gap-[var(--width-page-column-gap)] lg:grid-cols-page-tablet lg:pr-[var(--width-page-column-gap)] lg:max-w-tablet xl:px-0 xl:grid-cols-page-desktop xl:max-w-desktop">
