    ...
    <PageLayout>
      <article>
        ...
        <div className="my-3 px-3 py-2 rounded-lg bg-teal-50 border border-teal-200 grid grid-cols-[20px_1fr] gap-3">
            <svg className="text-teal-500" width="20" height="20" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill="currentColor" d="M10 2C5.58172 2 2 5.58172 2 10C2 14.4183 5.58172 18 10 18C14.4183 18 18 14.4183 18 10C18 5.58172 14.4183 2 10 2ZM10 5C10.5523 5 11 5.44772 11 6V10C11 10.5523 10.5523 11 10 11C9.44772 11 9 10.5523 9 10V6C9 5.44772 9.44772 5 10 5ZM10 15C9.44772 15 9 14.5523 9 14C9 13.4477 9.44772 13 10 13C10.5523 13 11 13.4477 11 14C11 14.5523 10.5523 15 10 15Z"/></svg>
            <div className="text-color-default font-sans text-small text-bold">Please notice that callout should be used with caution and shound not be overused. Too many callouts would make innefective.</div>
        </div>
      </article>
    </PageLayout>
